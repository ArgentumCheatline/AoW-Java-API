...
/**
 * Encapsulate an {@link Event} that define when receive the result of the login.
 */
public final class PlayerErrorEvent extends Event {
    ...
    /**
     * Default constructor for {@link PlayerErrorEvent}.
     */
    public PlayerErrorEvent(boolean isValid, String message) {
        super(false);
        this.mValid = isValid;
