...
/**
 * Encapsulate an {@link Event} that define when {@link Session} recv a message.
 */
public final class SessionRecvMessageEvent extends Event {
     ...
     */
    public SessionRecvMessageEvent(String function, JsonObject body) {
        super(true);
