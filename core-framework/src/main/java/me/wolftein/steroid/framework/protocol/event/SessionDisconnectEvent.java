...
/**
 * Encapsulate an {@link Event} that define when {@link Session} is disconnected.
 */
public final class SessionDisconnectEvent extends Event {
    /**
     * Default constructor for {@link SessionDisconnectEvent}.
     */
